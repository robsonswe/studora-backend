...
public class ConcursoUpdateRequest {
    ...
    private java.util.List<ProvaUpdateRequest> provas;

    // Constructors
    public ConcursoUpdateRequest() {}

    public ConcursoUpdateRequest(Long instituicaoId, Long bancaId, Integer ano, Integer mes, java.util.List<Long> cargos) {
