    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "201", description = "Subtema criado com sucesso",
                content = @Content(
                    schema = @Schema(implementation = SubtemaDetailDto.class),
                    examples = @ExampleObject(value = "{\"id\": 3, \"nome\": \"Direito à Vida\", \"tema\": {\"id\": 1, \"disciplinaId\": 1, \"disciplinaNome\": \"Direito Constitucional\", \"nome\": \"Direitos Fundamentais\", \"totalEstudos\": 0, \"ultimoEstudo\": null, \"totalSubtemas\": 0, \"subtemasEstudados\": 0, \"totalQuestoes\": 0, \"questoesRespondidas\": 0, \"questoesAcertadas\": 0, \"mediaTempoResposta\": null, \"dificuldadeRespostas\": {}}, \"totalEstudos\": 0, \"ultimoEstudo\": null, \"totalQuestoes\": 0, \"questoesRespondidas\": 0, \"questoesAcertadas\": 0, \"mediaTempoResposta\": null, \"dificuldadeRespostas\": {}}")
                )),
    ...
    @Operation(
        ...
        responses = {
            @ApiResponse(responseCode = "200", description = "Subtema atualizado com sucesso",
                content = @Content(
                    schema = @Schema(implementation = SubtemaDetailDto.class),
                    examples = @ExampleObject(value = "{\"id\": 1, \"nome\": \"Habeas Corpus e Habeas Data\", \"tema\": {\"id\": 1, \"disciplinaId\": 1, \"disciplinaNome\": \"Direito Constitucional\", \"nome\": \"Remédios Constitucionais\", \"totalEstudos\": 0, \"ultimoEstudo\": null, \"totalSubtemas\": 0, \"subtemasEstudados\": 0, \"totalQuestoes\": 0, \"questoesRespondidas\": 0, \"questoesAcertadas\": 0, \"mediaTempoResposta\": null, \"dificuldadeRespostas\": {}}, \"totalEstudos\": 0, \"ultimoEstudo\": null, \"totalQuestoes\": 0, \"questoesRespondidas\": 0, \"questoesAcertadas\": 0, \"mediaTempoResposta\": null, \"dificuldadeRespostas\": {}}")
                )),
            @ApiResponse(responseCode = "400", description = "Dados inválidos",
                content = @Content(mediaType = "application/problem+json",
                    schema = @Schema(implementation = ProblemDetail.class),
